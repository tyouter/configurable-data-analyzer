...
def generate_detailed_report(data_df, event_attributes, actual_events_set, defined_events):
    ...
    business_value = {
        ...
        'rednote_post_num': '📊低 - 其他字段',
        'rednote_search_result_tab_title': '⭐中 - 搜索标签，搜索体验分析',
        'rednote_post_is_op_rec': '⭐中 - 运营推荐标识',
        'rednote_post_is_recuser': '📊低 - 其他字段',
        'rednote_poi_typ': '📊低 - 其他字段',
        'rednote_travel_guide_id': '⭐中 - AI旅行指南标识',
        'rednote_travel_guide_title': '⭐中 - 交叉旅行指南标题',
        'rednote_prfl_typ': '📊低 - 其他字段',
        'rednote_user_logging_status': '📊低 - 其他字段',
        'rednote_post_is_like': '📊低 - 其他字段'
    }
